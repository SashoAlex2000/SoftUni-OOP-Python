...
# # print(len(test_book_store))
# #
# # print(test_book_store.receive_book("CCC", 10))
# # print(test_book_store.sell_book("CCC", 20))
# print(test_book_store)

# second_test_booksstore = Bookstore("cici")

# test_book_store.total_sold_books = 10
...
# test_book_store = Bookstore(10)
#
# test_book_store.receive_book("CCC", 9)
# print(test_book_store.sell_book("CCC", -5))
# print(test_book_store.availability_in_store_by_book_titles)
# print(len(test_book_store))
# print(test_book_store._Bookstore.__total_sold_books)

# test_book_store = Bookstore(10)
# test_book_store.receive_book("CCC", 9)
#
# test_book_store.sell_book("CCC", 9)
# print(test_book_store.availability_in_store_by_book_titles)
